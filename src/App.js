...
import TextWithParameters from "./Components/TextWithParameters";
import TextWithParameters2 from "./Components/TextWithParameters2";

const dataArr = [
    "https://www.lrt.lt/img/2016/09/05/142552-992272-1287x836.jpg",
...
function App() {
    ...
    return (
        <div className="App">
            ...
            {/*komponentai sukurti atskirai*/}
            <Cats/>
            <Dogs/>
            <Panda/>
            {/*sukurtas komponentas, i kuri galima irasyt props, ir panaudoti daug kartu su skirtingais kintamaisiais*/}
            <div className="d-flex space-ev">
                <Photo image={dataArr[0]} text="Panda"/>
                <Photo text="Cat" image={dataArr[1]}/>
                <Photo text="Dog" image={dataArr[2]}/>
            </div>

            <div className="d-flex space-ev column align-center">
                <TextWithParameters height={arr[0].height} text={arr[0].text} width={arr[0].width}
                                    color={arr[0].color}/>
                <TextWithParameters height={arr[1].height} text={arr[1].text} width={arr[1].width}
                                    color={arr[1].color}/>
                <TextWithParameters height={arr[2].height} text={arr[2].text} width={arr[2].width}
                                    color={arr[2].color}/>
            </div>

            <TextWithParameters2 arr2={arr[0]}/>
